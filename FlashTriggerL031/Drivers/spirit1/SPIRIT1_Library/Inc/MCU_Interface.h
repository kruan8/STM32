...
#define SpiritSpiInit                                                  SPIspirit_init
#define SpiritSpiWriteRegisters(cRegAddress, cNbBytes, pcBuffer)       SPIspirit_WriteRegisters(cRegAddress, cNbBytes, pcBuffer)
#define SpiritSpiReadRegisters(cRegAddress, cNbBytes, pcBuffer)        SPIspirit_ReadRegisters(cRegAddress, cNbBytes, pcBuffer)
#define SpiritSpiCommandStrobes(cCommandCode)                          SPIspirit_CommandStrobes(cCommandCode)
#define SpiritSpiWriteLinearFifo(cNbBytes, pcBuffer)                   SPIspirit_WriteFifo(cNbBytes, pcBuffer)
#define SpiritSpiReadLinearFifo(cNbBytes, pcBuffer)                    SPIspirit_ReadFifo(cNbBytes, pcBuffer)
